<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" CodeBehind="AddCard.aspx.cs" Inherits="Project_LordCardShop.Views.AddCard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Add New Card</h2>
    <p>Fill out the form below to insert a new card into the database.</p>
    <hr />
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <asp:Button ID="btnInsert" runat="server" Text="Insert Card" CssClass="btn btn-success" OnClick="btnInsert_Click" />
